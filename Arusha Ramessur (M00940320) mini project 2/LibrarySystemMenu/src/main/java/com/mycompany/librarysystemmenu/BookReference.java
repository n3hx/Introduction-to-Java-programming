...
public class BookReference {
    ...
    public BookReference() { //default constructor
    ...
    public BookReference(int id, String bn, String au, String pd, int qty, int sec, int sh) { //second constructor passing parameters
    ...
    public void PrintBook(){
        ...
        String book = "BookID is "+BookID 
                ...
                +"\nThe "+BookName+" book is found in section "+Section+" and on shelf "+Shelf;
        ...
        System.out.println("The "+BookName+" book is found in section "+Section+" and on shelf "+Shelf+"\n\n");
